...
The model is designed to simulate sequential learning on a dataset that originally contains engineered features,
by restructuring the input into segments and applying both:
